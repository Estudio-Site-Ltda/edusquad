...
2. **Objetivo principal** — verbo de Bloom explícito + nível cognitivo
...
- 1º terço: Lembrar + Compreender
- 2º terço: Aplicar + Analisar
- 3º terço: Avaliar + Criar
...
## Mapa de Progressão Bloom
| Capítulo | Título | Bloom |
|----------|--------|-------|
| 1 | {título} | Lembrar |
| ... | ... | ... |
...
## Capítulo 1: {Título}
**Objetivo:** Ao final, você será capaz de [verbo] [objeto]. (Bloom N)
...
- [ ] Verbo de Bloom explícito em cada objetivo principal
- [ ] Progressão cognitiva crescente
